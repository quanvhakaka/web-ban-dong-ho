...
.btn{ display:block; width:300px; background:#c0392b; color:#fff; padding:14px; text-align:center; margin-top:15px; border-radius:5px; cursor:pointer; } 
...
.policy-item span{ font-size:20px; } 
...
.policy-item a{
    ...
    color: inherit; /* giữ màu giống text bình thường */
}
/* Bỏ gạch chân tất cả link */
a {
    text-decoration: none;
    color: inherit;
}
...
<tr><td>Chất liệu</td><td><?php echo $sp['ChatLieu']; ?></td></tr> 
<tr><td>Màu sắc</td><td><?php echo $sp['MauSac']; ?></td></tr> 
<tr><td>Loại đá</td><td><?php echo $sp['LoaiDa']; ?></td></tr> 
<tr><td>Trọng lượng</td><td><?php echo $sp['TrongLuong']; ?></td></tr> 
<tr><td>Kích thước</td><td><?php echo $sp['KichThuoc']; ?></td></tr> 
</table> 
...
<?php foreach($spTuongTu as $row){ ?>
    <div class="related-item">
        <a href="index.php?trang=jewelry&id=<?php echo $row['MaSP']; ?>">
